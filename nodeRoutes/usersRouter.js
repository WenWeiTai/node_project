...
// ===============================================登录页
// 前端ajax请求接口 ->  http://localhost:3000/users/login
...
// 前端ajax请求接口 ->  http://localhost:3000/users/register
...
// ===============================================用户管理页
// 前端ajax请求接口 ->  http://localhost:3000/users/getUserInfo
router.get("/getUsersInfo", function(req,res) {
    /* 
        分页功能
            根据前端请求，每次返回请求的数据渲染
                http://localhost:3000/users/getUserInfo?page=1&pageSize=5
...
// 搜索功能
// 前端ajax请求接口 ->  http://localhost:3000/users/searchUsersInfo
router.get("/searchUsersInfo",function(req,res){
    var page = Number(req.query.page) || 1;
    var pageSize = Number(req.query.pageSize) || 5;
    var totalSize = 0;
...
// 删除功能
// 前端ajax请求接口 ->  http://localhost:3000/users/deleteUsersInfo
router.get("/deleteUsersInfo",function(req,res){
